...
# Edge Impulse library for Fishpond

This is a C++ library that lets you run the impulse for "Fishpond" (https://studio.edgeimpulse.com/studio/839830) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
